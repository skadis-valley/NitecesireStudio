...
<div class="container" style="margin-top: 10%;">
	...
	<h2 class="mt-4 mb-3">Order Carricature Bouquet</h2>
	...
	<div class="row" style="box-shadow: 0px 27px 59px rgba(0, 0, 0, 0.15);">
		<div class="col-lg-10">
			<div class="get_in_touch_contents">
				...
				<form style="margin-top:10%; margin-bottom: 10%; margin-left:10%; margin-right:10%;" enctype="multipart/form-data" action="{{url('order/bouquet/order')}}" method="post" id="formEditPembeli">
					{{csrf_field()}}
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<select class="form-control" id="selectSizeFrame" name="idProduk">
								...
								<option value="{{$data->nama_produk}}, {{$data->nama_produk}}, {{$data->harga_produk}}, {{$data->id_produk}}">{{$data->nama_produk}} | {{$data->ukuran_produk}} | Rp.{{$data->harga_produk}}</option>
								@endforeach
							</select> 
						</div>
					</div>
					...
					<div class="form-group row">
						<label for="inputPassword" class="col-sm-4 col-form-label text-right">Event</label>
						<div class="col-sm-8">
							<input type="text" name="acara" class="form-control" id="inputPassword" placeholder="Example: Graduation, Birthday, Wedding ">
						</div>
					</div>
					<div class="form-group row">
						<label for="inputPassword" class="col-sm-4 col-form-label text-right">Theme</label>
						<div class="col-sm-8">
							<input type="text" name="tema" class="form-control" id="inputPassword" placeholder="Example: Disney, Princess, Japan, Java, Bali">
						</div>
					</div>
					<div class="form-group row">
						<label for="inputPassword" class="col-sm-4 col-form-label text-right">Bouquet Color</label>
						<div class="col-sm-8">
							<input type="text" name="warnaBouquet" class="form-control" id="inputPassword" placeholder="Example: Black, Red, White, Tosca"">
						</div>
					</div>
					<div class="form-group row">
						<label for="inputPassword" class="col-sm-4 col-form-label text-right">Flower Color</label>
						<div class="col-sm-8">
							<input type="text" name="warnaBunga" class="form-control" id="inputPassword" placeholder="Example: Black, Red, White, Tosca">
						</div>
					</div>
					<div class="form-group row">
						<label for="inputPassword" class="col-sm-4 col-form-label text-right">Additional Information</label>
						<div class="col-sm-8">
							<textarea name="infoTambahan" rows="5" class="form-control" id="inputPassword" placeholder="Additional infromation"></textarea>
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<select class="form-control" name="tambahSafePackage" id="tambahSafePackage" required>
								<option value="" selected disabled hidden>Choose here</option>
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<textarea rows="5" name="alamat" class="form-control" id="inputPassword" placeholder="Sending address"></textarea>
						</div>
					</div>
					<div class="form-group row">
