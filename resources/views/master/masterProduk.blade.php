				...
				<div class="card-header">
					...
					<div class="card-body">
						...
						<div class="pull-right" style="padding-bottom:20px">
							<button class="btn btn-success" data-toggle="modal" data-target="#modalAddProduk">
							...
							<table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
								<thead>
									<tr>
										...
										<th style="min-width:120px;">Ukuran</th>
								...
								<tbody>
									...
									<tr id="{{$data->id_produk}}">
										<td align="left">{{$data->nama_produk}}</td>
										<td align="left">{{$data->kategori_produk}}</td>
										<td align="left">{{$data->ukuran_produk}}</td>
										<td><img src="{{asset($data->gambar_produk)}}" id="showgambarAdd" style="max-width:200px;max-height:200px;float:left;" /></td>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form style="margin-top:10%; margin-bottom: 10%; margin-left:10%; margin-right:10%;" enctype="multipart/form-data" action="{{url('/master/product/store')}}" method="post" id="formAddKaryawan">
								{{csrf_field()}}
								<div class="form-group row">
									<label for="filePhoto" class="col-sm-4 col-form-label text-right">Nama Produk</label>
									<div class="col-sm-8" id="addBrowsePhoto">
										<input type="text" class="form-control" name="namaAdd" placeholder="Masukkan Nama Produk" required>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<select class="form-control" type="text" name="kategoriAdd" id="kategoriAdd">
								...
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" name="ukuranAdd" placeholder="Masukkan Ukuran Produk" required>
									</div>
								</div>
								<div class="form-group row">
									<label class="col-sm-4 col-form-label text-right" required>Gambar Produk</label>
									<div class="col-sm-8">
										<input type="file" id="inputgambarAdd" class="form-control" name="gambarAdd" class="validate" required/>
										<img src="" id="showgambarAdd" style="max-width:200px;max-height:200px;float:left;" />
									</div>
								</div>
								<div class="form-group row">
									<label class="col-sm-4 col-form-label text-right">Harga Produk</label>
									<div class="col-sm-8">
										<input type="number" id="hargaAdd" name="hargaAdd" class="form-control" placeholder="Masukkan harga" required>
									</div>
								</div>
								<div class="row">
									<label class="col-sm-4 col-form-label text-right"></label>
									<div class="col-sm-8">
										<button id="review_submit" type="submit" style="width: 100%;"  class="form-control red_button message_submit_btn trans_300" value="Submit">Tambah Produk</button>
									</div>
								</div>
							</form>
	...
	<script>
		$(document).ready(function () {
				...
				*/
				...
				$("#inputgambarAdd").change(function () {
					readURL(this);
				});
				$("#inputgambarAdd2").change(function () {
					if (input.files && input.files[0]) {
						var reader = new FileReader();

						reader.onload = function (e) {
							$('#showgambarAdd2').attr('src', e.target.result);
						}
